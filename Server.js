...
const registerCoBrowseSocket = require('./sockets/coBrowseSocket');
...
// wrap the Express app in a plain HTTP server so Socket.io can attach
// to the same port, needed for the live co-browsing feature
